diem_quan_trong = input("Nhập điểm quan trọng cần kiểm tra: ")
ma_buu_chinh= input("Nhập mã bưu chính cần kiểm tra: ")
...
ket_qua = la_ma_buu_chinh_hop_li(diem_quan_trong, ma_buu_chinh)
